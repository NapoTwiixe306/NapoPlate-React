    ...
    <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="sm:flex sm:flex-col sm:align-center">
            <h2 className="text-3xl font-extrabold text-gray-900 dark:text-white sm:text-center">Plans tarifaires</h2>
            ...
            <div className="relative self-center mt-6 bg-gray-100 dark:bg-gray-700 rounded-lg p-0.5 flex sm:mt-8">
              <button
                ...
                className={`${
                  !isAnnual ? 'bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-600' : 'border border-transparent'
          ...
          <div className="mt-12 space-y-4 sm:mt-16 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-6 lg:max-w-4xl lg:mx-auto xl:max-w-none xl:mx-0 xl:grid-cols-3">
            {pricingPlans.map((plan) => (
              <div key={plan.name} className="border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm divide-y divide-gray-200 dark:divide-gray-700">
                <div className="p-6">
                  ...
                  <p className="mt-4">
                    ...
                    <span className="text-base font-medium text-gray-500 dark:text-gray-400"> à vie</span>
                  </p>
                  <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Paiement unique</p>
                  <a
                    href="#"
